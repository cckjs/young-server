  ...
  try {
    ...
    val f = setupFuture.flatMap { _ =>
      ...
      val insertAction: DBIO[Option[Int]] = coffees ++= Seq(
        (1,"Colombian", 101, 7.99, 0, 0),
        (2,"French_Roast", 49, 8.99, 0, 0),
        (3,"Espresso", 150, 9.99, 0, 0),
        (4,"Colombian_Decaf", 101, 8.99, 0, 0),
        (5,"French_Roast_Decaf", 49, 9.99, 0, 0))
      ...
      val filterQuery: Query[Coffees, (Int,String, Int, Double, Int, Int), Seq] =
      ...
      val deleteQuery: Query[Coffees, (Int,String, Int, Double, Int, Int), Seq] =
      ...
      val sortByPriceQuery: Query[Coffees, (Int,String, Int, Double, Int, Int), Seq] =
